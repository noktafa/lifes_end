...
fn mutate_pattern(cells: &mut Vec<(i32, i32)>, count: usize) {
...
pub fn get_level(level_number: usize) -> (Vec<PatternPlacement>, Vec<WaveConfig>, f32) {
    ...
    for i in 0..enemy_count {
        ...
        let mut cells = pick_pattern(&mut rng, level_number);
        ...
        if i < mutated_count {
            ...
            mutate_pattern(&mut cells, mutation_cells);
        }
    ...
    let waves = if level_number >= 3 && level_number % 3 == 0 {
        ...
        for j in 0..wave_enemy_count {
            ...
            let ox = (angle.cos() * dist) as i32;
            let oy = (angle.sin() * dist) as i32;
            let cells = pick_pattern(&mut rng, level_number);
